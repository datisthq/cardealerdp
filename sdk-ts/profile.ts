...
export interface Package {
  $schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.7/extension/profile.json"
  /**
   * @minItems 1
   */
...
export interface CarResource {
   ...
   */
  data: [{}, ...{}[]]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.7/extension/schemas/car.json"
}
export interface DealerResource {
   ...
   */
  data: [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.7/extension/schemas/dealer.json"
}
export interface ShowroomResource {
   ...
   */
  data: [{}, ...{}[]]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.7/extension/schemas/showroom.json"
}
