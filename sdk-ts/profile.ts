...
export interface CarResource {
   ...
   */
  data?: [] | [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.1.5/extension/schemas/car.json"
}
export interface DealerResource {
   ...
   */
  data?: [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.1.5/extension/schemas/dealer.json"
}
export interface ShowroomResource {
   ...
   */
  data?: [] | [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.1.5/extension/schemas/showroom.json"
}
