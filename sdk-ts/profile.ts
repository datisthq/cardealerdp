...
export interface CarResource {
   ...
   */
  data?: [] | [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/car.json"
}
export interface DealerResource {
   ...
   */
  data?: [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/dealer.json"
}
export interface ShowroomResource {
   ...
   */
  data?: [] | [{}]
  schema: "https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/showroom.json"
}
