...
class CarResource(BaseModel):
    ...
    schema_: Literal[
        'https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/car.json'
    ] = Field(..., alias='schema')
...
class DealerResource(BaseModel):
    ...
    schema_: Literal[
        'https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/dealer.json'
    ] = Field(..., alias='schema')
...
class ShowroomResource(BaseModel):
    ...
    schema_: Literal[
        'https://raw.githubusercontent.com/datisthq/cardealerdp/v0.2.0/extension/schemas/showroom.json'
    ] = Field(..., alias='schema')
